            ...
            <div class="col-md-8">
                ...
                <div class="row">
                    <!div class="col-md-12" style="background:white; top:150px; height:440px; border-radius:10px;">
                        ...
                        echo '<label class="col-md-12" style="width: 100%; color: black; background: white; border-radius: 10px; padding: 10px;">First line will contain : N </br>
                        Next line contain N space saperated integers. </label>';
                        
                        ?>
                    <!/div>
            		<?php
					nl();
					echo '<label class="col-md-12" style="width: 100%; color: black; background: white; border-radius: 10px; padding: 10px;">Enter your input below</label>';
					nl();
					...
					<input type="submit" id="singlebutton" name="singlebutton" class="btn btn-success" value="SUBMIT" style="width: 100%;" />
					</label>';
					?>
                </div>
