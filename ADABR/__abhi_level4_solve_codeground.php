...
$cracked = $Database->did_you_ever_cracked_abhi( $User->getUsername() );



//echo "USER : ".$User->getUsername();
//echo "PAGE UNDER MAINTENANCE : errors debugging process";



$flag = false;

$username = "jabhinav11@gmail.com";
...
if(!$cracked && isset($_REQUEST['codearea']) && $_REQUEST['codearea'] != ''){
    if($Database->getLevel( $User->getUsername() ) != 5)
    {
        header('location: level'.$level.'.php');
    }
        ...
        if(l4_submit($_REQUEST['codearea'], 40) && check_operator( $_REQUEST['codearea'] ) <= 6)
        {
            ...
            if( checkSafeProgram($User->getUsername(), $fprog, $foutput, $finput) ){
                ...
                if(l4check_output($val,$val1)){
                    ...
                    if(true){
                        $orig = $Database->adabr_level4_showtestcase_abhi();
                        //$orig = $Database->adabr_level4_showtestcase_akela();
                        //106
                        ...
                        if(true && l4check_output($val, json_encode($orig))){
                            ...
                            $Database->add100( $User->getUsername() );
                ...
                <div class="row">
                    ...
                    <!div class="col-md-12" style="background:white; top:150px; height:440px; border-radius:10px;">
                        ...
                        if($cracked){
                            ...
                            echo "You have already cracked the code for @jabhinav11@gmail.com";
                            echo '</textarea>';
...
<?php
                                ...
                                nl();
                                echo '<label class="col-md-12" style="width: 100%; color: black; background: white; border-radius: 10px; padding: 10px;">Enter your C-program below to steal @'."jabhinav11@nitt.edu".'</label>';
                                nl();
