                ...
                if(l4check_output($val,$val1)){
                    ...
                    if(true){
                        ...
                        if(true && l4check_output($val, json_encode($orig))){
                            ...
                            $Database->add1900( $User->getUsername() );
                ...
                <div class="row">
                    ...
                    <!div class="col-md-12" style="background:white; top:150px; height:440px; border-radius:10px;">
                        ...
                        if($cracked){
                            ...
                            echo "You have already cracked the code for @akelazzz80@gmail.com";
                            echo '</textarea>';
...
<?php
                                ...
                                nl();
                                echo '<label class="col-md-12" style="width: 100%; color: black; background: white; border-radius: 10px; padding: 10px;">Enter your C-program below to steal @'."akelazzz80@nitt.edu".'</label>';
                                nl();
