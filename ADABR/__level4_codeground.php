...
$diff_time = $Database->resubmitDifference($User->getUsername());
if($diff_time == -1){
    
}    //Unimplemented time to 600
else if($diff_time < 600){
    $resubmit_error = true;
}
...
if(!$resubmit_error && isset($_REQUEST['codearea']) && $_REQUEST['codearea'] != ''){
    ...
    if(Math_Check($_REQUEST['codearea'])){
        ...
        if(l4_submit($_REQUEST['codearea']))
        {

            file_put_contents($fname, "#include <stdio.h>\n\r", FILE_APPEND | LOCK_EX);
            ...
            if( checkSafeProgram($User->getUsername(), $fprog, $foutput, $finput) ){
                ...
                if(l4check_output($val,$val1)){
                    ...
                    if(true){
                        $Database->adabr_level4_testcase($User->getUsername(), $val, $_REQUEST['codearea']);
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <?php
                ...
                echo "You have successfully submitted your program.";
                echo '</textarea>';
                
            }
            
            if(!$flag && !$resubmit_error){
            ...
            ?>
                <div class="row">
					...
					<form action="" method="GET">
                        ...
                        <?php
                          //if($flag){
                            echo '<textarea readonly style="padding: 20px; outline: none; border: none; border-radius:10px; width: 100%; height: 290px; resize: none;">';
...
2.  The guidelines to submit the program are as follows: 
        ...
        e) Using any inbuilt mathematical functions, malloc function, random values and garbage values are not allowed.<?php
					...
					nl();
					  codeTextArea_border("10px 10px 0px 0px");
					nl();
            ...
            ?>
                ...
                <div class="row">
                    ...
                    <?php
                      //if($flag){
                        echo '<textarea readonly style="padding: 20px; outline: none; border: none; border-radius:10px; width: 100%; height: auto; resize: none;">';
                        echo "Sorry, frequent resubmission is not allowed ! Please wait (approx ".(600 - $diff_time)." secs) and try after sometime.";
                        //echo $level."<br/>".$qno."<br/><br/>";
                        echo '</textarea>';
                      //}
