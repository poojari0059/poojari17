...
public function submission_check($uname,$level,$ques)
{
    ...
    $sql1="select count(*) as c from adaprimequestionsolved where `username`='$uname'";
	$result1=mysqli_query($this->conn,$sql1);
	$row1=mysqli_fetch_assoc($result1);
    if($row1['c']==0){
      $sql1="insert into adaprimequestionsolved(username , totalscore ,level1)  values('".$uname."',0,0)";
	  $result1=mysqli_query($this->conn,$sql1);  
    }
