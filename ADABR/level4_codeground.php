...
2.  The guidelines to submit the program are as follows: 
        ...
        b) A maximum length of the program allowed is 30 characters.
        ...
        g) You can try experimenting which things are allowed below<?php
            ...
            ?>
                ...
                <div class="row">
                    ...
                    <?php
                      //if($flag){
                        echo '<textarea readonly style="padding: 20px; outline: none; border: none; border-radius:10px; width: 100%; height: auto; resize: none;">';
                        echo "Sorry, frequent resubmission is not allowed ! Please wait (approx ".(1200 - $diff_time)." secs) and try after sometime.";
                        //echo $level."<br/>".$qno."<br/><br/>";
                        echo '</textarea>';
                      //}
