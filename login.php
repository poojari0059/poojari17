...
if(isset($_REQUEST['flogin']) && isset($_REQUEST["gender"])){
        ...
        if(isset($_SESSION["ADAPRIME_user_id"]) && isset($_SESSION["ADAPRIME_full_name"]) && $_SESSION["ADAPRIME_user_id"] != "" && $_SESSION["ADAPRIME_full_name"] != "" ){      
            ...
            if($Database->register($_SESSION["ADAPRIME_user_id"],$_SESSION["ADAPRIME_full_name"],$_REQUEST["gender"])){
                ...
                //confirmation mail
              $mailbody = 'Hello '.$_SESSION["ADAPRIME_full_name"].',<br>You have successfully registered for <a target="blank" href="https://www.pragyan.org/adaventure/">Adaventure</a><br>
<a target="blank" href="https://www.pragyan.org/adaventure/ADAPRIME/">Click here</a> to play Adaventure Prime throughout 21<sup>st</sup> to 28<sup>th</sup> Feb.<br>
<a target="blank" href="https://www.pragyan.org/adaventure/ADABR/">Click here</a> to play Break-n Ride throughout 22<sup>nd</sup> to 27<sup>th</sup> Feb (Phase II will be opened for all even if you have not solved previous levels  on 27<sup>th</sup> Feb). <br><br><br>
Regards,<br>
Team Adaventure<br>
<a target="blank" href="http://www.nitt.edu/">NIT Tiruchirappalli</a>';
                if($phpmail->sendmail($_SESSION["ADAPRIME_user_id"],'Adaventure registration confirmation',$mailbody)){
                }
                  ...
                  <div class="container-fluid mytnav">
                    ...
                    <div class="collapse navbar-collapse" id="navbar-collapse">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                          <li id="btnRegister"><a href="https://www.pragyan.org/17/home/events/code_it/adaventure/" target="blank" class="navmenu">
            ...
            <div class="col-md-12">
                <div id="modalLogin" style="background: linear-gradient(to left, #00d2ff , #3a7bd5);">
                    <form class="pure-form" method="POST">
                        ...
                        <a target="blank" href="https://www.pragyan.org/17/home/events/code_it/adaventure/+login&subaction=resetPasswd" style="color:white;"> Forgot Password?</a>
                    </form>
                </div>
                <?php
                if($login_pass){
            ...
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                ...
                <div class="modal-header">
                  ...
                  <a class="close disabled" style="float:right;">Login to Play</a>
...
<span style="color:red;">SOLUTION SUBMISSION LINK (AWARD : 100)</span> : <a target="blank" href="ADABR/__abhi_level4_solve_codeground.php">https://www.pragyan.org/adaventure/ADABR/__abhi_level4_solve_codeground.php</a>
          ...
          <ul>
            ...
            <li style="color:red;">The following users are for providing competition in the game. These users will not crack other's code. If they win, they will not be part of any position. If you happen to see them in your lounge, surely you can crack their code to increase your own score.
            <ul>
