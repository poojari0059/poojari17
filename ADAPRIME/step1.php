                ...
                <div class="row">
                    ...
                    <div class="col-md-6" style="background:white; top:150px; height:200px; border-radius:10px;">
						...
						<div class="form-group">
						  <label class="col-md-4 control-label" for="passwordinput">Enter Level Code</label>
						  <div class="col-md-5">
							<input id="passwordinput" name="passwordinput" type="password" placeholder="Level Code" class="form-control input-md" required="">
						...
						<div class="form-group">
						  ...
						  <div class="col-md-4">
							<input type="submit" id="singlebutton" name="singlebutton" class="btn btn-success" value="GO" />
						  </div>
						</div>
